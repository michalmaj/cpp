/*
 * Template Specialization External
*/
#include <iostream>
...
class Matrix{
public:
  explicit Matrix() {std::cout << "<typename T=std::string, int Line=10, int Column=Line>\n"; }
...
class Matrix<T, 3, 3>{
public:
  explicit Matrix() {std::cout << "<T, 3, 3>\n"; }
  int numberOfElements() const;
};
...
public:
  explicit Matrix() {std::cout << "<int, 3, 3>\n"; }
  int numberOfElements() const;
};
