 ...
 * If we create a string view or copy a strng view, there is no memory allocation necessary. This is in
 * contrast to a string; creating a string or copying a string requires memory allocaton.
*/
#include <cassert>
#include <iostream>
#include <string> 
...
// Thanks to the global overload operator new, we can observe each memory allocation.
