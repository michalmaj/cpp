 ...
 * string involved for creating a C++ string. That changes with C++14, because the new C++ standard supports
 * C++ string literals: std::string str{"string"'s}. With the suffix s, the C string literal "string 
 * literal" becomes a C++ string literal: "string literal"s.
 *
 * Overview of the methods to create and delete a C++ string:
 *  Method                                          Example
 *  Default                                         std::string str
 *  Copies from a C++ string                        std::string str(oth)
 *  Moves from a C++ string                         std::string(std::move(oth))
